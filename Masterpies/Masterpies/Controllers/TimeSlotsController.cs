...
namespace Masterpies.Controllers
{
    public class TimeSlotsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TimeSlotID,StartTime,EndTime,Available,Date")] TimeSlot timeSlot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TimeSlotID,StartTime,EndTime,Available,Date")] TimeSlot timeSlot)
        {
            if (ModelState.IsValid)
            {
